...
export const tracks: Track[] = [
    {
        ...
        features: [
            ...
            { name: 'AI Integrations', desc: 'AI-powered product descriptions, chat support, and smart recommendations.', icon: 'auto_awesome' },
    ...
    },
    {
        ...
        features: [
            ...
            { name: 'AI-Powered Insights', desc: 'Smart recommendations for inventory, pricing, and customer engagement.', icon: 'auto_awesome' },
            { name: 'Multi-Location Support', desc: 'Run multiple shops or warehouses from one connected platform.', icon: 'corporate_fare' },
