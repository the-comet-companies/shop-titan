...
const features: Feature[] = [
    ...
    {
        eyebrow: 'Decoration-Aware Catalog',
        title: 'Product pages that handle decoration the right way',
        desc: 'A real catalog with the details print shops actually need. Color swatches, size matrices, decoration options, and live pricing, all tied back to what is in stock.',
        bullets: [
            'Color swatches with real product images',
            'Size and variant selectors per style',
    ...
    },
    {
        ...
        desc: 'No more email threads, lost files, or revision chaos. Customers drag their artwork right into the order so production gets exactly what was approved, every time.',
        bullets: [
            'Drag and drop upload on every product',
            'Supports vector, raster, and source files',
            'Art attached to the order, not the inbox',
            'Approvals tracked so nothing slips',
        ],
        image: {
            src: '/website/DragAndDrop.png',
            width: 1389,
            height: 724,
