                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <ul className="space-y-3 md:space-y-4 text-sm text-gray-400">
                            ...
                            <li><MotionLink href="/get-started/scheduling" whileHover={hoverProps} className={linkClass}>Production Scheduling</MotionLink></li>
                    ...
                    <div className="sm:col-span-2 lg:col-span-3">
                        ...
                        <form className="flex flex-col gap-2 w-full" onSubmit={(e) => e.preventDefault()}>
                            <input
                                ...
                                className="w-full min-h-[44px] bg-[#161616] border border-[#222] text-gray-300 placeholder-gray-500 px-4 py-3 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary rounded-none transition-colors"
                                required
                            />
                            <button
                                type="submit"
